<?php 
  ...
  if (isset($_POST['logInBtn'])) {
    ...
    if ($user) {
			$status = "Active Now";
			$statement = $db->prepare("UPDATE users SET status = '$status' WHERE id=$user->id");
   		$statement->execute();
      $_SESSION['users'] = $user;
...
<head>
		...
		<!-- Bootstrap core CSS -->
		<link href="swipe-chat-platform/dist/css/lib/bootstrap.min.css" type="text/css" rel="stylesheet">
		<!-- Swipe core CSS -->
							...
							<div class="col-md-12">
								<div class="content">
									...
									<form method="post">
										...
										<button type="submit" name="logInBtn" class="btn button">Sign In</button>
										<div class="callout">
